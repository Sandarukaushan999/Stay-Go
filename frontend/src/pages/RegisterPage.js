...
const ROLES = ['student', 'driver', 'technician'];
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input style={styles.input} type="password" placeholder="Password (min 6 chars)" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} required minLength={6} />
...
const styles = {
  ...
  button: { width: '100%', padding: '0.7rem', background: '#48bb78', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '1rem', cursor: 'pointer' },
