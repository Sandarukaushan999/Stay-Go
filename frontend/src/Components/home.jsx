...
function Home({ headerNavItems, onNavigateToRide, onNavigateToRoommate, onNavigateToPage, onNavigateToAuth }) {
  ...
  function handleDirectNavigation(target) {
    ...
    if (target.type === 'section') {
      if (target.value === 'roommates' && onNavigateToRoommate) {
        onNavigateToRoommate()
        return
      }
