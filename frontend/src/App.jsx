...
import RoomMateMatchingModule from './Components/Room_Mate_Matching'
...
function buildPrimaryNavItems(navigateTo) {
  return [
    ...
    { label: 'Roommates', type: 'button', onClick: () => navigateTo('roommate') },
...
function App() {
  ...
  if (screen === 'roommate') {
    return <RoomMateMatchingModule onExit={() => navigateTo('home', 'roommates')} />
  }
  ...
  return (
    <Home
      headerNavItems={primaryNavItems}
      onNavigateToRide={() => navigateTo('ride')}
      onNavigateToRoommate={() => navigateTo('roommate')}
      onNavigateToPage={navigateTo}
